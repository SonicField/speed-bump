"""PEP 669 (sys.monitoring) integration for selective slowdown.

This module registers monitoring callbacks for function calls and applies
delays to calls matching the configured target patterns.
"""
